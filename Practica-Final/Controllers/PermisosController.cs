...
namespace Practica_Final.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Empleado,Desde,Hasta,Comentarios")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Empleado,Desde,Hasta,Comentarios")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
