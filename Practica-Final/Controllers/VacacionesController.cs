...
namespace Practica_Final.Controllers
{
    public class VacacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Empleado,Desde,Hasta,Año,Comentarios")] Vacaciones vacaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Empleado,Desde,Hasta,Año,Comentarios")] Vacaciones vacaciones)
        {
            if (ModelState.IsValid)
            {
